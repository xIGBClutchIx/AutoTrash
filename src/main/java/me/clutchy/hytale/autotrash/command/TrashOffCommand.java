 ...
 * Disables auto-trash.
 */
public final class TrashOffCommand extends CommandBase {
     ...
     */
    public TrashOffCommand(@NonNullDecl ComponentType<EntityStore, AutoTrashPlayerSettings> settingsComponentType) {
        super("off", "Disable auto-trash.");
    ...
    protected void executeSync(@NonNullDecl CommandContext context) {
        ...
        context.sendMessage(Message.raw("AutoTrash is now disabled."));
    }
}
